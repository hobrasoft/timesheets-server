...
ControllerAttendanceSummary::ControllerAttendanceSummary(HobrasoftHttpd::HttpConnection *parent) : AbstractController(parent) {
}
...
void ControllerAttendanceSummary::serviceIdPut(HobrasoftHttpd::HttpRequest *request, HobrasoftHttpd::HttpResponse *response, const QVariantMap &data) {
    Dbt::AttendanceSummary x = Dbt::AttendanceSummary::fromMap(data);
    x.locked_user = authenticatedUser()->user();
    serviceOK(request, response, putKey(db()->save(x)));
}


void ControllerAttendanceSummary::serviceIdPost(HobrasoftHttpd::HttpRequest *request, HobrasoftHttpd::HttpResponse *response, const QVariantMap &data) {
