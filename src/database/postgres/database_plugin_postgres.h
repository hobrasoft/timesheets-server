...
class DatabasePluginPostgres : public Db::Plugins::DatabasePlugin {
  ...
  public:
   ...
   ~DatabasePluginPostgres();
    ...
    QList<Dbt::CategoriesOverview>          categoriesOverview(const QStringList& statuses) Q_DECL_OVERRIDE;
    ...
    QList<Dbt::Employees>                   attendanceChecklist(const QDate& month) Q_DECL_OVERRIDE;
    ...
    bool                                    canAccessAttendance(int employee) Q_DECL_OVERRIDE;
